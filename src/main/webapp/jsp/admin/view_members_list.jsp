		...
		<div id="paging_menu">
			...
			<ul class="pagination pagination-sm justify-content-center">
				<li class="page-item"><a class="page-link"
					href="${contextPath}/admin/paging_action.do?page=1"> <span class="material-icons">
							keyboard_double_arrow_left </span>
				</a></li>
				<li class="page-item"><a class="page-link"
					href="${contextPath}/admin/paging_action.do?page=${pageDTO.page-1<=0 ? 1 : pageDTO.page-1}"> <span
						class="material-icons">keyboard_arrow_left</span>
				</a></li>
				<li class="page-item active"><a class="page-link"
					href="${contextPath}/admin/paging_action.do?page=${pageDTO.page}"> <span
						style="font-size: 1.4em">&nbsp;${pageDTO.page}&nbsp;</span>
				</a></li>
				<li class="page-item"><a class="page-link"
					href="${contextPath}/admin/paging_action.do?page=${pageDTO.page>=pageDTO.lastPage ? pageDTO.page : pageDTO.page+1}">
						<span class="material-icons">keyboard_arrow_right</span>
				</a></li>
				<li class="page-item"><a class="page-link"
					href="${contextPath}/admin/paging_action.do?page=${pageDTO.lastPage}"> <span
