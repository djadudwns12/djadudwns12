...
<body>
	...
	<div id="paging_menu">
		...
		<ul class="pagination pagination-sm justify-content-center">
			<li class="page-item">
				<a class="page-link"
					href="${contextPath}/board/board_search_list.do?search_page=1&search_kind=${searchVO.searchKind}&search_word=${searchVO.searchWord}"> 
			...
			<li class="page-item"><a class="page-link"
				href="${contextPath}/board/board_search_list.do?search_page=${pageDTO.page-1<=0 ? 1 : pageDTO.page-1}&search_kind=${searchVO.searchKind}&search_word=${searchVO.searchWord}"> <span
					class="material-icons"> keyboard_arrow_left </span>
			</a></li>
			<li class="page-item active"><a class="page-link"
				href="${contextPath}/board/board_search_list.do?search_page=${pageDTO.page}&search_kind=${searchVO.searchKind}&search_word=${searchVO.searchWord}"> <span
					style="font-size: 1.4em">&nbsp;${pageDTO.page}&nbsp;</span>
			</a></li>
			<li class="page-item"><a class="page-link"
				href="${contextPath}/board/board_search_list.do?search_page=${pageDTO.page>=pageDTO.lastPage ? pageDTO.page : pageDTO.page+1}&search_kind=${searchVO.searchKind}&search_word=${searchVO.searchWord}">
					<span class="material-icons"> keyboard_arrow_right </span>
			</a></li>
			<li class="page-item"><a class="page-link"
				href="${contextPath}/board/board_search_list.do?search_page=${pageDTO.lastPage}&search_kind=${searchVO.searchKind}&search_word=${searchVO.searchWord}"> <span
